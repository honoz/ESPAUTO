...
#ifndef ESPAUTO_SWIFT_H
#define ESPAUTO_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ESPAUTO",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7ESPAUTO17EspAutoBleService")
@interface EspAutoBleService : NSObject
...
@interface EspAutoBleService (SWIFT_EXTENSION(ESPAUTO)) <CBPeripheralDelegate>
...
@class NSString;
@class NSNumber;
@interface EspAutoBleService (SWIFT_EXTENSION(ESPAUTO)) <CBCentralManagerDelegate>
